...
public class SourceFile {
    ...
    private Class containedClass; // the class contained in the source file
    ...
    public static void main(String[] args) {
        SourceFile test = new SourceFile("C:\\Users\\tungx_000\\Downloads\\Compressed\\UML-Visualizer-master\\Attribute.java");
